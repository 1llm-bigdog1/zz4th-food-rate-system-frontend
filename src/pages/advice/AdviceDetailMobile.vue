        ...
        <section v-if="currentAdvice" class="detail-card">
            <div class="card-top">
                <div class="author-chip">
                    ...
                    <span v-else>{{ getUserInitial(currentAdvice) }}</span>
                </div>
                <div class="card-headings">
                    <div class="user-name">{{ currentAdvice.nickname || '同学' }}</div>
            ...
            <div class="action-row">
                <a-button block @click="openReplyBox('advice', currentAdvice.id)">{{ text.reply }}</a-button>
            </div>
            <div v-if="isReplyingTo('advice', currentAdvice.id)" class="reply-box">
                <div class="field-label">{{ text.replyAdviceTitle }}</div>
