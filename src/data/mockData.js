...
export const createMockSelectionComments = (selectionId = 1) => [
    new Selection_Comment(
        `${selectionId}-comment-1`,
        '\u540c\u5b66A',
        '2026-03-11',
    ...
    new Selection_Comment(
        `${selectionId}-comment-4`,
        '\u540c\u5b66D',
        '2026-03-13',
        '\u6211\u4e5f\u89c9\u5f97\u8fd9\u6761\u63a8\u8350\u5f88\u51c6\uff0c\u5c24\u5176\u662f\u4ef7\u683c\u90e8\u5206\u5f88\u6709\u53c2\u8003\u4ef7\u503c\u3002',
        selectionId,
        { 'user-id': '\u540c\u5b66A', 'comment-id': `${selectionId}-comment-1` },
    ),
    new Selection_Comment(
        `${selectionId}-comment-5`,
        '\u540c\u5b66E',
        '2026-03-14',
        '\u6392\u961f\u65f6\u95f4\u8fd9\u70b9\u8bf4\u5f97\u5bf9\uff0c\u6211\u4e00\u822c\u4f1a\u9519\u5f00\u4e2d\u5348\u9ad8\u5cf0\u518d\u53bb\u3002',
        selectionId,
        { 'user-id': '\u540c\u5b66B', 'comment-id': `${selectionId}-comment-2` },
    ),
    new Selection_Comment(
        `${selectionId}-comment-6`,
        '\u540c\u5b66F',
        '2026-03-14',
        '\u6211\u4e0a\u6b21\u5c31\u662f\u770b\u4e86A\u540c\u5b66\u7684\u8bc4\u8bba\u53bb\u4e70\u7684\uff0c\u786e\u5b9e\u6ca1\u8e29\u5751\u3002',
        selectionId,
        { 'user-id': '\u540c\u5b66D', 'comment-id': `${selectionId}-comment-4` },
    ),
];

export const createMockAdvices = () => [
...
export const createMockAdviceComments = (adviceId = 1) => [
    new Advice_Comment(
        `${adviceId}-comment-1`,
        '\u540c\u5b66A',
        '2026-03-11',
...
export const createMockSuggestions = () => [
...
export const createMockSuggestionComments = (suggestionId = 1) => [
    new Suggestion_Comment(
        `${suggestionId}-comment-1`,
        '\u540c\u5b66A',
        '2026-03-11',
        suggestionId,
